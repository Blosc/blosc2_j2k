...
* Use the official Blosc2 global codec id 39 for J2K.
* Require python-blosc2 4.4.3 or newer, which exposes the official J2K codec
...
* Document the current HDF5 status: direct Blosc2 usage works with
  ...
  filter built against a c-blosc2 runtime that knows codec id 39.
...
* Changed initialization of the grok library
  ...
  the `blosc2-j2k` package to use the plugin.


## Changes from 0.2.0 to 0.2.1

* Avoid calling `set_params_defaults` for setting own blosc2_j2k defaults.
