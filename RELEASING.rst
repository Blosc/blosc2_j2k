...
- Check that *VERSION* symbols in blosc2_j2k/__init__.py
...
If ``import`` fails to find ``libblosc2_j2k.so``, try changing the name of the ``blosc2_j2k`` directory to ``blosc2-j2k``, run ``pytest``, and then change it back.
...
- Create a new release visiting https://github.com/Blosc/blosc2_j2k/releases/new
...
- Edit *VERSION* symbols in blosc2_j2k/__init__.py *and* pyproject.toml in main to increment the
