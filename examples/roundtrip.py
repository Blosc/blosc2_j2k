##############################################################################
# blosc2_j2k: J2K codec plugin for Blosc2
#
...
def compress(im, urlpath=None, **kwargs):
    ...
    Other keyword arguments are passed to blosc2_j2k.set_params_defaults(...)
    """
    # Convert the image to a numpy array
    np_array = np.asarray(im)

    # Set the parameters that will be used by the codec
    blosc2_j2k.set_params_defaults(**kwargs)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description='Compress the given input image using Blosc2 and blosc2_j2k',
    )
    ...
    kwargs = {'cod_format': blosc2_j2k.GrkFileFmt.GRK_FMT_JP2,
              'verbose': True,
