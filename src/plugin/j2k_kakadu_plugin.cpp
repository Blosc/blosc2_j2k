/*********************************************************************
 * Kakadu replacement backend entry point for blosc2_j2k.
 *
 * This file only exports the runtime plugin symbol.  The Kakadu implementation
 * lives in kakadu_backend.cpp so the core blosc2_j2k library remains
...
// to the Kakadu implementation without exposing Kakadu headers to blosc2_j2k.
