...
#ifndef BLOSC2_J2K_PLUGIN_LOADER_H
#define BLOSC2_J2K_PLUGIN_LOADER_H
...
// Release all loaded replacement backends.  Called from blosc2_j2k_destroy().
...
#endif  // BLOSC2_J2K_PLUGIN_LOADER_H
